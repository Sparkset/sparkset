        ...
        <form @submit.prevent="go">
            ...
            <div class="field field--half">
                <label>
                    <span>
                        Email
                        <a v-if="!editing && client.get('email')"
            ...
            <div class="field field--half">
                <label>
                    <span>
                        LinkedIn
                        <a v-if="!editing && client.get('linkedin')"
            ...
            <div class="field field--half">
                <label>
                    <span>
                        Cell Phone
                        <a v-if="!editing && client.get('cellPhone')"
            ...
            <div class="field field--half">
                <label>
                    <span>
                        Work Phone
                        <a v-if="!editing && client.get('workPhone')"
            ...
            <div class="field field--half field--with--dropdown">
                <label>
                    <span>
                        ...
                        <router-link v-if="!editing && client.get('company').id"
            ...
            <div class="field field--half">
                <label>
                    <span>
                        Company LinkedIn
                        <a v-if="!editing && client.get('company').get('linkedin')"
            ...
            <div class="field field--half">
                <label>
                    <span>
                        Company Facebook
                        <a v-if="!editing && client.get('company').get('facebook')"
            ...
            <div class="field field--half">
                <label>
                    <span>
                        Company Instagram
                        <a v-if="!editing && client.get('company').get('instagram')"
    ...
    export default {
        ...
        methods: {
            ...
            archiveClient() {
                const vm = this;
                vm.client
                    .set("archived", !vm.client.get("archived"))
                    .save()
                    .catch(error => {
                        alert(error);
                    });
